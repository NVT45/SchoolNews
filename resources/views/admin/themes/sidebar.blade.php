...
{{--                {{route('admin.users.index')}}--}}
    ...
    <li class="nav-item">
        ...
        <div id="collapsePost" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Options:</h6>
                <a class="collapse-item" href="{{asset('admin/news')}}">All News</a>
                <a class="collapse-item" href="{{asset('admin/news/add')}}">Create News</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseCate" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Options</h6>
                <a class="collapse-item" href="{{asset('admin/category')}}">All Categories</a>
                <a class="collapse-item" href="{{asset('admin/category')}}">Create Categories</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseMedia" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Options</h6>
                <a class="collapse-item" href="{{asset('admin/type')}}">All Types</a>
                <a class="collapse-item" href="{{asset('admin/type/add')}}">Create Type</a>
            </div>
        </div>
    </li>
